...
$sql = "SELECT rental.*, transaction.*
        FROM rental
        JOIN transaction ON rental.id = transaction.rent_id";
...
{
    global $conn;
    $sqlProperty = "SELECT * FROM properties WHERE id = $propertyId";
    $resultProperty = mysqli_query($conn, $sqlProperty);
    ...
    $row = mysqli_fetch_assoc($resultProperty);
    if ($row) {
        return $row['title'];
    } else {
    ...
    <!-- Sidebar Menu -->
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                  <a href="rentals.php" class="nav-link bg-secondary text-white py-2 rounded hover-effect">
                      <i class="nav-icon fas fa-key"></i>
                  ...
                  <thead class="table-dark text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo getPropertyName($row['property_id']); ?></td>
