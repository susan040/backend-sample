...
$sql = "SELECT u.id, u.name, u.address, u.phone, u.email, u.user_type, u.image,
       CASE WHEN o.is_verified = 1 THEN 'Yes' ELSE 'No' END AS is_verified
       FROM users u LEFT JOIN otp o ON u.id = o.user_id";
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href="add_users.php" class="btn btn-outline-primary">Add Users</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="../uploads/<?php echo $row['image']; ?>" alt="Img" width="70" height="70"></td>
                        <td>
                          <?php if ($row['user_type'] != 'admin') { ?>
                              <a href="edit_users.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit"></i></a>
                              <a href="delete_users.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash"></i></a>
                          <?php } ?>
                        </td>
                    </tr>
                    <?php
