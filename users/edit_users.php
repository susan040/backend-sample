...
// if ($user['is_active'] != 1) {
//     $_SESSION['flash_message'] = "Cannot edit user with inactive account!";
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card card-secondary">
                    ...
                    <!-- form start -->
                    <!-- form start -->
                   <form role="form" method="POST" action="edit_users.php?id=<?php echo $id;?>" enctype="multipart/form-data">
                        <div class="card-body">
                         ...
                         <div class="form-group">
                                ...
                                <select class="form-control" id="type" name="user_type" required>
                                    <option value="Customer"
                                        <?php if ($user['user_type'] === 'Customer') echo 'selected'; ?>>Customer
                                    </option>
                                </select>
                            </div>
                        <div class="form-group">
